...
public class AdminDashboard extends JFrame {
    ...
    private void createStatsCards(JPanel contentPanel) {
        ...
        // Create cards
        RoundedPanel usersCard = createStatCard("Total Users", "125", new Color(50,205,50));
        RoundedPanel accountsCard = createStatCard("Active Accounts", "89", new Color(255, 20, 147));
        RoundedPanel balanceCard = createStatCard("Total Balance", "MMK1.25M", new Color(142, 68, 173));
    ...
    private void navigateToPage(String pageName) {
        ...
        switch(pageName) {
            ...
            case "Accounts":
                ...
                JOptionPane.showMessageDialog(this, "Accounts page - To be implemented");
                return;
            case "Transactions":
                // newPage = new AdminTransactionsPage();
                JOptionPane.showMessageDialog(this, "Transactions page - To be implemented");
                return;
            case "Security":
                // newPage = new AdminSecurityPage();
                JOptionPane.showMessageDialog(this, "Security page - To be implemented");
                return;
            case "Settings":
                // newPage = new AdminSettingsPage();
                JOptionPane.showMessageDialog(this, "Settings page - To be implemented");
                return;
        }
